...
public class EditServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Part part=request.getPart("image"); //part used for images
...
// iske andar purani details hai or inhe replace karna hai upar wali details se
            ...
            //update into database dao m ek or function banao update user
